...
export const CarFilterControls = ({
  ...
  const { make, bodyType, fuelType, transmission, priceRange, mileageRange } = currentFilters;
      ...
      <div className="space-y-4">
        ...
        <div className="px-2">
          <Slider
            ...
            step={1000}
            value={mileageRange}
            onValueChange={(value) => onFilterChange("mileageRange", value)}
          />
        </div>
        <div className="flex items-center justify-between">
          <div className="font-medium text-sm">{mileageRange[0]} mi</div>
          <div className="font-medium text-sm">{mileageRange[1]} mi</div>
        </div>
      </div>
