  ...
  try {
    ...
    if (search) {
      where.OR = [
        ...
        { description: { contains: search, mode: "insensitive" } }, // Add description to search
      ];
    }
    ...
    if (minMileage || maxMileage) {
      where.mileage = {};
      if (minMileage) {
        where.mileage.gte = parseInt(minMileage);
      }
      if (maxMileage) {
  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        mileageRange: {
          min: mileageAggregations._min.mileage || 0,
          max: mileageAggregations._max.mileage || 500000,
        },
      },
    };
  } catch (error) {
